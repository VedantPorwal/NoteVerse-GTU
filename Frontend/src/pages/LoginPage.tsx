    ...
    <main className="min-h-screen flex items-center justify-center px-4 py-10 sm:p-6 relative overflow-hidden bg-surface">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 font-medium">Access your curated academic collection</p>
        </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  required
                />
                <button type="button" onClick={() => setShowPw(p => !p)} className="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-slate-600 transition-colors">
